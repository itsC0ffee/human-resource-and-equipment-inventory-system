							...
							<section>
								...
								<div class="col-md-2 col-sm-12">
									<div class="form-group">
											<input name="emp_id" type="text" class="form-control wizard-required" required="true" autocomplete="off" placeholder="Search Employee ID">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="emp_id" type="text" class="form-control wizard-required" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
											...
											<input name="barangay" type="text" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
											<label>City:</label>
											<input name="city" type="text" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
											...
											<input name="zipcode" type="file" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">

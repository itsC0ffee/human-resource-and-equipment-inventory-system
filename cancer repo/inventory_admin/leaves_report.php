					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								// Assigning a value to $status based on the condition
								$status = $condition ? 1 : 2;
								$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tblemployees.Department,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.ToDate,tblleaves.FromDate,tblleaves.num_days,tblleaves.location,tblleaves.Status, tblleaves.admin_status from tblleaves join tblemployees on tblleaves.empid=tblemployees.emp_id where tblleaves.admin_status= '$status' order by lid desc limit 10";

...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,MiddleName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,sched_time_in,sched_time_out,Status, location) VALUES('$fname','$mname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$user_role','$phonenumber','$sched_time_in','$sched_time_out','$status', 'NO-IMAGE-AVAILABLE.jpg')         
		") or die(mysqli_error()); ?>

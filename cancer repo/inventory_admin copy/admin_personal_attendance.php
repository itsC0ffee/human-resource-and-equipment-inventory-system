	...
	<div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="form-group">
				...
				<div class="dropdown">
					<button class="btn btn-secondary dropdown-toggle" type="button" id="hide-on-print" data-bs-toggle="dropdown" aria-expanded="false">Export</button>
					...
					<button onclick="printTable()" class="btn btn-primary" name="print" id="hide-on-print" >Print</button>
				</div>
			</div>	
				<div class="pd-20">
					...
					<table class="data-table table stripe hover nowrap"  id="attendanceTable">
						...
						<tbody>
							<tr>
								 ...
								 <?php 
                         $sql = "SELECT date, time_in, time_out, status FROM tbattendance WHERE emp_id = '$session_id'";

...
<?php
	...
	elseif($leave_days <= 0)
	{
		...
		$sql="INSERT INTO hr_leaves(leave_type,to_date,from_date,description,status,is_read,emp_id,num_days,posting_date,location) VALUES(:leave_type,:fromdate,:todate,:description,:status,:isread,:empid,:num_days,:datePosting,:location)";
								...
								<div class="row">
									...
									<div class="col-md-6 col-sm-12">
										<div class="form-group">
											...
											<?php $sql = "SELECT  leave_type from hr_leave_type";
											$query = $dbh -> prepare($sql);
											$query->execute();
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										...
										<div class="form-group">
											...
											<input name="image" id="file" type="file" class="form-control" required="true" autocomplete="off">
										</div>

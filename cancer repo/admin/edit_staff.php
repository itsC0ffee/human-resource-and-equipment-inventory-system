...
<?php
	...
	$result = mysqli_query($conn,"update hr_employees set first_name='$fname', last_name='$lname', email_id='$email', gender='$gender', dob='$dob', department='$department', address='$address', av_leave='$leave_days', role='$user_role', phone_number='$phonenumber' where emp_id='$get_id'         
		"); 		
	if ($result) {
				...
				<div class="pd-20 card-box mb-30">
					...
					<div class="wizard-content">
						<form method="post" action="">
							<section>
								<?php
									$query = mysqli_query($conn,"select * from hr_employees where emp_id = '$get_id' ")or die(mysqli_error());
								...
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="firstname" type="text" class="form-control wizard-required" required="true" autocomplete="off" value="<?php echo $row['first_name']; ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label >Last Name :</label>
											<input name="lastname" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['last_name']; ?>">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Email Address :</label>
											<input name="email" type="email" class="form-control" required="true" autocomplete="off" value="<?php echo $row['email_id']; ?>">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="phonenumber" type="text" class="form-control" required="true" autocomplete="off"value="<?php echo $row['phone_number']; ?>">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="department" class="custom-select form-control" required="true" autocomplete="off">
												<?php
													$query_staff = mysqli_query($conn,"select * from hr_employees join  hr_departments where emp_id = '$get_id'")or die(mysqli_error());
													$row_staff = mysqli_fetch_array($query_staff);
													
												 ?>
												<option value="<?php echo $row_staff['department_short_name']; ?>"><?php echo $row_staff['department_name']; ?></option>
													<?php

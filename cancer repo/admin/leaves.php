					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$status=0;
								$sql = "SELECT hr_leaves.id as lid,hr_employees.first_name,hr_employees.last_name,hr_employees.location,hr_employees.emp_id,hr_leaves.leave_type,hr_leaves.posting_date,hr_leaves.to_date,hr_leaves.from_date,hr_leaves.num_days,hr_leaves.location,hr_leaves.status, hr_leaves.admin_status from hr_leaves join hr_employees on hr_leaves.emp_id=hr_employees.emp_id where hr_leaves.status= '$status' order by lid desc limit 10";
								...
								<div class="table-actions">
									<a href="leave_details.php?leaveid=<?php echo $row['lid'];?>" data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
									<a href="admin_dashboard.php?leaveid=<?php echo $row['lid'] ?>" data-color="#e95959"><i class="icon-copy dw dw-delete-3"></i></a>
								</div>
								</td>
							</tr>
							<?php }?>

                    ...
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            <tr>
								...
								$status=0;
								$query = $dbh->prepare("
										SELECT hr_leaves.id AS lid, hr_employees.first_name, hr_employees.last_name, hr_employees.location, hr_employees.emp_id,
										hr_leaves.leave_type, hr_leaves.posting_date, hr_leaves.to_date, hr_leaves.from_date, hr_leaves.num_days, hr_leaves.location,
										hr_leaves.status, hr_leaves.admin_status
										FROM hr_leaves
										JOIN hr_employees ON hr_leaves.emp_id = hr_employees.emp_id
										WHERE hr_leaves.status = :status
										ORDER BY lid DESC
										LIMIT 10;
									");
                                ...
                                <td><a
                                        href="../uploads/<?php echo $row['location']; ?>"><?php echo $row['location']; ?></a>
                                </td>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <a href="leave_details.php?leaveid=<?php echo $row['lid'];?>"
                                            data-color="#265ed7"><i class="icon-copy dw dw-edit2"></i></a>
                                        <a href="admin_dashboard.php?leaveid=<?php echo $row['lid'] ?>"

	...
	if(isset($_POST['update'])) { 
        ...
        if ($status === '2') {
            $sql = "UPDATE hr_leaves 
                    SET registra_remarks = :description, 
                        admin_status = :status,
                        status = :status  
                    WHERE id = :did";
            ...
            $queryLeave->bindParam(':description', $description, PDO::PARAM_STR);
            $queryLeave->bindParam(':status', $status, PDO::PARAM_STR);
            $queryLeave->bindParam(':did', $did, PDO::PARAM_STR);
            $queryLeave->execute();
        
            $sqlEmployee = "UPDATE hr_employees 
                            SET av_leave = :av_leave 
                            WHERE emp_id = (SELECT emp_id FROM hr_leaves WHERE id = :did)";
            
            $queryEmployee = $dbh->prepare($sqlEmployee);
            $queryEmployee->bindParam(':av_leave', $REMLEAVE, PDO::PARAM_STR);
            $queryEmployee->bindParam(':did', $did, PDO::PARAM_STR);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="selectpicker form-control" data-style="btn-outline-info"
                                        readonly value="<?php echo htmlentities($result->leave_type);?>">
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="selectpicker form-control" data-style="btn-outline-info"
                                        readonly name="av_leave" value="<?php echo htmlentities($result->av_leave);?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="selectpicker form-control" data-style="btn-outline-info"
                                        readonly
                                        value="From <?php echo htmlentities($result->from_date);?> to <?php echo htmlentities($result->to_date);?>">
                                </div>
                            </div>

                        </div>
                        <div class="form-group row">
                            <label style="font-size:16px;" class="col-sm-12 col-md-2 col-form-label"><b>Leave
                                    Reason</b></label>

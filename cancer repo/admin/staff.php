					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select first_name,last_name,emp_id,email_id,phone_number,reg_date,sched_time_in,sched_time_out from hr_employees where role != 'Admin' ORDER BY hr_employees.emp_id") or die(mysqli_error());

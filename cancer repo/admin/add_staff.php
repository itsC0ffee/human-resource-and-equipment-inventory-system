...
<?php
	if(isset($_POST['add_staff'])) {
		...
		$stmt = $dbh->prepare("SELECT * FROM hr_employees WHERE email_id = :email");
		...
		if ($count > 0) {
			...
			$insertStmt->bindParam(':leave_days', $leave_days);
			$insertStmt->bindParam(':user_role', $user_role);
			$insertStmt->bindParam(':phonenumber', $phonenumber);
			$insertStmt->bindParam(':sched_time_in', $sched_time_in);
			$insertStmt->bindParam(':sched_time_out', $sched_time_out);
                            ...
                            <section>
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="middlename" type="text" class="form-control" required="true"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="password" type="text" class="form-control" id="password"
                                                required="true" autocomplete="off" onclick="generatePassword()">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="leave_days" type="number" class="form-control" required="true"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <label>Time - In :</label>
                                            <input name="sched_time_in" type="time" class="form-control" required="true"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input name="sched_time_out" type="time" class="form-control"
                                                required="true" autocomplete="off">
                                        </div>
                                    </div>
